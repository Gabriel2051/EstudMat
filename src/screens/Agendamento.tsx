...
export default function AgendamentoScreen() {
  ...
  const salvarAgendamento = async () => {
    ...
    if (editandoIndex !== null) {
      ...
      await promiseWithTimeout(set(agendamentoRef, novo), 7000)
    ...
    await promiseWithTimeout(set(novoRef, novo), 7000)
  ...
  const carregarAgendamentos = async () => {
    ...
    try {
      ...
      const snapshot = await promiseWithTimeout(get(agRef), 7000)
    ...
    showAlert("Confirmar exclusão", "Deseja realmente excluir este agendamento?", [
      { text: "Cancelar", style: "cancel" },
      {
        ...
        onPress: async () => {
          ...
          try {
            await promiseWithTimeout(remove(agendamentoRef), 7000)
  ...
  return (
    <PageLayout title="Agendamento" subtitle="Organize seus horários" activeScreen="Agendamento">
          ...
          <View style={styles.listSection}>
            ...
            {agendamentos.length === 0 ? (
              ...
              agendamentos.map((item, index) => (
                <View key={item.id || index} style={styles.agendamentoItem}>
